...
This Bill of Materials POM can be used to ease dependency management when referencing multiple Apache Commons Numbers artifacts.

Documentation
-------------

More information can be found on the [Apache Commons Numbers homepage](https://commons.apache.org/proper/commons-numbers).
Questions related to the usage of Apache Commons Numbers Sampling should be posted to the [user mailing list][ml].
