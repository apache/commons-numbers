...
public final class FactorialDouble {
    ...
    /**
     * @deprecated Since 1.1 the cache size argument is ignored. Use {@link #create()} to obtain an instance.
     *
     * <p>As of Numbers 1.1 all representable factorials up to {@code n=170} are tabulated.
