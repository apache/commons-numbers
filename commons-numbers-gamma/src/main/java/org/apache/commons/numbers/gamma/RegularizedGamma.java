...
public final class RegularizedGamma {
     ...
     */
    public static final class ArgumentA {
        /** Argument a. */
         ...
         */
        public static ArgumentA of(double a) {
            if (invalid(a)) {
     ...
     * <p>Class is immutable.
     */
    public static final class ArgumentX {
        /** Argument x. */
         ...
         */
        public static ArgumentX of(double x) {
            if (invalid(x)) {
    ...
    public static final class P {
         ...
         * @see ArgumentA
         */
        public static double value(ArgumentA a,
                                   double x) {
            return value(a, x, DEFAULT_EPSILON, DEFAULT_ITERATIONS);
        }
