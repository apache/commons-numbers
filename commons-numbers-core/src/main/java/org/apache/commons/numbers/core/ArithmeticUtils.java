...
public final class ArithmeticUtils {
     ...
     */
    public static boolean isBetweenExclusive(int numberToCheck, int minimum, int maximum) {
     ...
     * @return true if numberToCheck is between minimum-exclusive and maximum-exclusive.
     */
    public static boolean isBetweenExclusive(long numberToCheck, long minimum, long maximum) {
        return numberToCheck > minimum && numberToCheck < maximum;
    }
     ...
     * @return true if numberToCheck is between minimum-exclusive and maximum-exclusive.
     */
    public static boolean isBetweenExclusive(double numberToCheck, double minimum, double maximum) {
        return numberToCheck > minimum && numberToCheck < maximum;
    }
